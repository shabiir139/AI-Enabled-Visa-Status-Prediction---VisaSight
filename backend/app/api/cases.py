...
async def list_visa_cases(
    ...
    try:
        ...
        # By adding count="exact" to the primary select query, PostgREST returns
        # both the paginated data and the exact total count of matching rows
        # in a single network round-trip instead of making two separate queries.
        ...
        # Parse total count from the single response object
