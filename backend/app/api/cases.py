...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt Optimization: Added count='exact' to single query to avoid redundant DB round-trip
        # Expected Impact: Reduces database queries per list request by 50% (from 2 to 1),
        # lowering latency by ~10-50ms depending on network conditions.
        ...
        # Extract count from the single result
