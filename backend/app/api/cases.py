...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt optimization: Added count="exact" to fetch data and total count in a single database round-trip
        # This halves database queries and prevents bugs from out-of-sync filters between data and count queries.
        ...
        # Get total count from the single round-trip result
