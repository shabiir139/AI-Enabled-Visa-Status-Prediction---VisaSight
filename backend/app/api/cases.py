...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt: Performance Optimization - Batch query and count in a single request
        # This reduces database round-trips and improves API response time by fetching the exact count along with the paginated data.
