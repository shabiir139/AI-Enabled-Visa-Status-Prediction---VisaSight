...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt Optimization: Use count="exact" with the main query to avoid an N+1/redundant DB round-trip
        ...
        # ⚡ Bolt Optimization: Extract total from result instead of a second query
