...
async def list_visa_cases(
    ...
    try:
        ...
        # 🎯 Why: Previously, fetching paginated cases required two round-trips to the database (N+1 query problem).
        # 📊 Impact: Halves the database load and network latency for the `/cases` endpoint.
