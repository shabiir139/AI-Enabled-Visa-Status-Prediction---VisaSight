...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt Optimization: Use count="exact" on primary query to avoid N+1 count query
        # This retrieves both paginated records and total row count in a single DB round-trip.
        ...
        # Extract total count from primary query result
