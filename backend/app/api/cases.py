...
async def list_visa_cases(
    ...
    try:
        ...
        # By adding count="exact" to the primary query, we get both the paginated records
        # and the total row count in one database call, eliminating the N+1 query problem.
