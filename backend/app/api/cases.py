...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt: Fetch paginated data and exact count in a single round-trip
        # Expected performance impact: Eliminates one database round trip (N+1 query issue for pagination)
