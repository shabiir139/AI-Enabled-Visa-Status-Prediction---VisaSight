...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt: Combine data fetch and total count into a single query using count="exact"
        # This halves database roundtrips and significantly improves endpoint latency.
        ...
        # Extract total from the combined query response
