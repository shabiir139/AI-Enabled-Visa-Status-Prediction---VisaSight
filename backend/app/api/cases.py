...
async def list_visa_cases(
    ...
    try:
        # ⚡ BOLT OPTIMIZATION: Combine data fetch and count into a single database query
        # Using count='exact' allows retrieving both the records and the total count in one network trip
        ...
        # Extract total count directly from the result object
