...
async def list_visa_cases(
    ...
    try:
        # Bolt: Optimize pagination by combining data and count in a single query
        # This eliminates an N+1 query pattern, saving one database round-trip per request.
        ...
        # Get total count directly from the primary result
