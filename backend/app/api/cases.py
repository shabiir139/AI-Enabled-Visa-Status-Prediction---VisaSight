...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt Optimization: Use select('*', count='exact') to fetch paginated data and total count in a single query,
        # eliminating the N+1 query issue and reducing database roundtrips.
        ...
        # Parse total from the single response object
