...
async def list_visa_cases(
    ...
    try:
        ...
        # Combine data fetch and count into a single query to avoid N+1 query problem.
        # Supabase's count="exact" gets the total matching records before range limits.
        ...
        # Extract total from the combined query result
