...
async def list_visa_cases(
    ...
    try:
        # ⚡ Bolt Optimization: Use a single round-trip for data and total count
        # Combining count='exact' with the data fetch saves a redundant database query
        # and avoids duplicating filter logic, improving API response time significantly.
