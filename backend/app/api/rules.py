...
async def list_visa_rules(
    ...
    try:
        # Bolt Optimization: Retrieve data and exact count in a single query to avoid N+1 DB round-trips
        ...
        # Total count is returned alongside data due to count="exact" modifier
