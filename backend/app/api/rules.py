...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use count="exact" in the main query to avoid an N+1 query problem.
        # This halves the number of database trips required for pagination, significantly improving backend performance.
        ...
        # Extract total count from the combined query
