...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Fetch total count in the same round-trip
        # Using count='exact' on the main query avoids N+1 database round-trips
        ...
        # ⚡ Bolt Optimization: Extract total from the single query result
