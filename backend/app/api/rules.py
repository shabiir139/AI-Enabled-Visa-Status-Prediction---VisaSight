...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use select('*', count='exact') to fetch data and total count in a single query
        # This eliminates the N+1 query and reduces database round-trips by 50%
