...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use a single query for data and exact count to prevent N+1 query problem
        # Reduces database roundtrips by 50% for this endpoint
        ...
        # Get total count directly from the result object
