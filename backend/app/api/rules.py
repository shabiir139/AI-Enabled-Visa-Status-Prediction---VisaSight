...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Fetch total count in the same round-trip as the paginated query
        # to avoid N+1 queries and ensure count matches exactly the filtered results.
        ...
        # Extract total count from the same result object
