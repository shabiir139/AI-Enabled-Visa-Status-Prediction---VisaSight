...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt: Consolidated pagination query
        # Use count="exact" to fetch both data and total count in a single database request
        # This halves the number of database queries for this endpoint, improving latency
        ...
        # The exact count is available on the result object
