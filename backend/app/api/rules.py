...
async def list_visa_rules(
    ...
    try:
        # Bolt performance optimization: use count="exact" in the same query
        # to avoid N+1 count queries and save a database roundtrip.
        ...
        # Extract total count using fallback pattern
