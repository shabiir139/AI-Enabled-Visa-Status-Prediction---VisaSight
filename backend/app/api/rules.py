...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Combine data fetch and count into a single query
        # to eliminate redundant database round-trips for pagination.
        ...
        # Get total count directly from the combined result
