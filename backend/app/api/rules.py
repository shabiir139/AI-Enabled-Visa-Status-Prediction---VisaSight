...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use a single query with count="exact" to avoid redundant DB round-trips
        # Reduces N+1 query problem by fetching paginated data and total count in one go.
