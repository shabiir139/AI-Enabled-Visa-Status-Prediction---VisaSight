...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use single roundtrip for pagination and count
        # Combining select with count='exact' avoids N+1 queries. PostgREST handles the count correctly while applying filters and ignoring range limits for the count itself.
        ...
        # Get total count directly from result
