...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt: Performance optimization - Fetch data and exact count in a single database roundtrip
        # Expected impact: ~50% reduction in database queries for pagination endpoints
        ...
        # Get total count from the same result object
