...
async def list_visa_rules(
    ...
    try:
        # Bolt Performance: Appending count="exact" avoids N+1 query problem by doing both data and count in 1 request
        ...
        # Bolt Performance: Use count directly from the result
