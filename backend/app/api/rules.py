...
async def list_visa_rules(
    ...
    try:
        # Performance optimization: Append count="exact" to the single query
        # to avoid N+1 query problem and redundant total counts calculation
        ...
        # Extract total safely from the combined result
