...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt: Combines data fetch and exact count into a single query.
        # This halves database latency for pagination by removing the secondary count request.
        ...
        # Extract total count from the same response object
