...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt: Fetch paginated data and exact count in a single query instead of two
        # This removes an unnecessary N+1 query and reduces latency by halving database round-trips
