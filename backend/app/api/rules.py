...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use select('*', count='exact') to fetch data and total count in a single round-trip
        # Impact: Eliminates a redundant database query, saving ~50-100ms of latency and reducing DB load.
