...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use single query with count='exact' to avoid N+1 network requests
        # fetching pagination data and count simultaneously instead of 2 roundtrips
        ...
        # Get total count directly from the paginated query response
