...
async def list_visa_rules(
    ...
    try:
        # Bolt performance optimization: Fetch paginated data and exact total count
        # in a single query by using count="exact", saving one DB roundtrip.
        ...
        # Extract the total count returned directly from the initial query
