...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use select('*', count='exact') to fetch data and count in a single roundtrip,
        # reducing DB queries from 2 to 1 for pagination.
        ...
        # Get total count from the single query result
