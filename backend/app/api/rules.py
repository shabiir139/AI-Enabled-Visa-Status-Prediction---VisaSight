...
async def list_visa_rules(
    ...
    try:
        # Combine pagination and total count in a single query to prevent N+1 queries
        # Expected Performance Impact: Eliminates 1 DB round-trip per request
        ...
        # Parse count from the response object
