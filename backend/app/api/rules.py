...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt: Optimize pagination by combining data and count fetch into a single query
        # Impact: Reduces database roundtrips by 50% for listing endpoints
        ...
        # Extract total count safely from the single response
