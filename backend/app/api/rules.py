...
async def list_visa_rules(
    ...
    try:
        # Bolt: Optimize pagination by getting exact count in the same query
        # This avoids a separate database round-trip for the count query
        ...
        # Extract total count from the same result
