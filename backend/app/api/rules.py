...
async def list_visa_rules(
    ...
    try:
        # ⚡ Bolt Optimization: Use select("*", count="exact") to fetch paginated rules and total count in a single query
        # Reduces database round-trips from 2 to 1 and ensures filters remain synchronized
