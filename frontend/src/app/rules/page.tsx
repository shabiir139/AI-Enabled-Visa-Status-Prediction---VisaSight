...
export default function RulesPage() {
    ...
    // Removed fetchRules from here to be inside useEffect or wrapped in useCallback
    // to satisfy exhaustive-deps, but since it depends on state setters,
    // it's cleaner to define it inside useEffect.
